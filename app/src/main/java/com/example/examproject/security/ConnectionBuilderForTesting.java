...
/**
 * An example implementation of {@link ConnectionBuilder} that permits connecting to http links, and
 * ignores certificates for https connections. *THIS SHOULD NOT BE USED IN PRODUCTION CODE*. It is
 * intended to facilitate easier testing of AppAuth against development servers only.
 */
public final class ConnectionBuilderForTesting implements ConnectionBuilder {
  ...
  @Nullable private static final SSLContext TRUSTING_CONTEXT;
  ...
  static {
    ...
    if (context != null) {
      try {
        context.init(null, ANY_CERT_MANAGER, new SecureRandom());
